export const serviceTabs = [
    ...
    services: [
      {
        ...
        list: `<ul>
          <li>Full-service F&B for concerts, festivals, sporting events</li>/n
          <li>Scalable kitchens and logistics for high-volume demands</li>/n
          <li>Quick service formats: food stations, mobile kitchens, pre-packed meals</li>/n
          <li>Custom menus built for diverse crowds & dietary needs</li>/n
          <li>On-site teams, 24/7 support, health & safety certified</li>/n
          </ul>`,
        list2: [
      ...
      },
      {
        ...
        list: `<ul>
          <li>Tailored menus for daily/weekly meal plans</li>/n
          <li>Nutritionally balanced, dietician-approved</li>/n
          <li>Scalable to 50 or 5,000+ employees</li>/n
          <li>Online dashboards for easy management</li>/n
          <li>Flexible contracts and subscription options</li>/n
          </ul>`,
        list2: [
  ...
  {
    tabTitle: "Corporate Event Catering",
    services: [
      {
        image: "/services/3.jpg",
        title: "Corporate Event Catering",
  ...
  {
    tabTitle: "Hospital & Institutional Catering",
    services: [
      {
        image: "/services/5.jpg",
        title: "Hospital & Institutional Catering",
  ...
  {
    tabTitle: "Private Events & Weddings",
    services: [
      {
        image: "/services/4.jpg",
        title: "Private Events & Weddings",
  ...
  {
    tabTitle: "Event Company Partnerships",
    services: [
      {
        image: "/services/5.jpg",
        title: "Event Company Partnerships",
